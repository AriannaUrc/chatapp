...
include("include/connection.php");
    ...
    if(isset($_POST['sign_up'])){
        ...
        if($name == ''){
            echo "<script>alert(We couldn't not verify your name)</script>";
        }
        if(strlen($pass)<8){
        ...
        $insert = "insert into users (user_name, user_pass, user_email, user_profile, user_country, user_gender) values('$name', '$pass', '$email', '$profile_pic', '$country', '$gender', )"; //todo encrypt password
